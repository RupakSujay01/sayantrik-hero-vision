                    ...
                    <div className="grid md:grid-cols-12 gap-12 items-start">
                        ...
                        <div className="md:col-span-4 lg:col-span-3">
                            <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100 sticky top-32">
                                ...
                                <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-2">Our Commitment</h3>
                        ...
                        <div className="md:col-span-8 lg:col-span-9">
                            ...
                            >
                                <blockquote className="text-lg md:text-2xl font-light text-gray-800 leading-relaxed pl-8 border-l-4 border-[#40a829] mb-12">
