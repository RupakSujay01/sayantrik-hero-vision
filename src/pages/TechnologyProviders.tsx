            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="flex flex-col lg:flex-row gap-12">
                    ...
                    <div className="flex-1 space-y-12 pb-20">
                        ...
                        >
                            <div className="border-b border-gray-200 pb-4 mb-8">
                                <h2 className="text-2xl font-bold text-gray-900">Sectors We Support</h2>
                            </div>
                        ...
                        >
                            <div className="border-b border-gray-200 pb-4 mb-8">
                                <h2 className="text-2xl font-bold text-gray-900">Partnership Models</h2>
                            </div>
                        ...
                        >
                            <div className="bg-[#ED2939] rounded-2xl p-8 md:p-12 text-white overflow-hidden relative shadow-xl hover:shadow-2xl transition-shadow duration-300">
                                <div className="absolute top-0 right-0 -mr-16 -mt-16 w-64 h-64 bg-white rounded-full opacity-10 blur-3xl animate-pulse" />
