...
const LctsPartnership = () => {
    return (
        <div className="min-h-screen bg-white">
            ...
            {/* FEL Section (3-Column Grid) */}
            <section className="py-20 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="mb-12">
                        <h2 className="text-3xl font-bold text-gray-900 mb-4">Detailed Project Life Cycle (FEL Focus)</h2>
                        <p className="text-gray-600">Integrated Services ensuring technical integrity and cost-certainty.</p>
                        <div className="h-1 w-20 bg-[#ED2939] mt-4" />
                    </div>

                    <div className="grid md:grid-cols-3 gap-8">
                        {/* FEL 1 */}
                        <div className="border border-gray-200 rounded-lg overflow-hidden group hover:border-[#ED2939] transition-colors">
                            <div className="bg-gray-100 p-4 border-b border-gray-200 group-hover:bg-[#ED2939] group-hover:text-white transition-colors">
                                <h3 className="font-bold text-lg uppercase">FEL 1: APPRAISE</h3>
                                <span className="text-xs opacity-75 block mt-1">(Concept)</span>
                            </div>
                            <div className="p-6">
                                <h4 className="font-bold text-gray-900 mb-2 text-sm uppercase">Objective</h4>
                                <p className="text-sm text-gray-600 mb-6">Define project viability and technical feasibility.</p>

                                <h4 className="font-bold text-gray-900 mb-2 text-sm uppercase">Deliverables</h4>
                                <ul className="text-sm text-gray-600 space-y-2 list-disc pl-4">
                                    <li>Feasibility Studies</li>
                                    <li>Conceptual Design & Selection</li>
                                    <li>Block Flow Diagrams (BFD)</li>
                                    <li>Initial CAPEX & OPEX Estimations</li>
                                    <li>Project Execution Strategy</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="border border-gray-200 rounded-lg overflow-hidden group hover:border-[#ED2939] transition-colors">
                            <div className="bg-gray-100 p-4 border-b border-gray-200 group-hover:bg-[#ED2939] group-hover:text-white transition-colors">
                                <h3 className="font-bold text-lg uppercase">FEL 2: SELECT</h3>
                                <span className="text-xs opacity-75 block mt-1">(Pre-FEED)</span>
                            </div>
                            <div className="p-6">
                                <h4 className="font-bold text-gray-900 mb-2 text-sm uppercase">Objective</h4>
                                <p className="text-sm text-gray-600 mb-6">Select the most efficient technical and commercial route.</p>

                                <h4 className="font-bold text-gray-900 mb-2 text-sm uppercase">Deliverables</h4>
                                <ul className="text-sm text-gray-600 space-y-2 list-disc pl-4">
                                    <li>Preliminary PFDs</li>
                                    <li>Heat and Mass Balance (H&MB)</li>
                                    <li>Preliminary Plot Plans</li>
                                    <li>Major Equipment List & LLI</li>
                                    <li>Cost Estimate (Class 4 / ±25%)</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="border border-gray-200 rounded-lg overflow-hidden group hover:border-[#ED2939] transition-colors">
                            <div className="bg-gray-100 p-4 border-b border-gray-200 group-hover:bg-[#ED2939] group-hover:text-white transition-colors">
                                <h3 className="font-bold text-lg uppercase">FEL 3: DEFINE</h3>
                                <span className="text-xs opacity-75 block mt-1">(FEED)</span>
                            </div>
                            <div className="p-6">
                                <h4 className="font-bold text-gray-900 mb-2 text-sm uppercase">Objective</h4>
                                <p className="text-sm text-gray-600 mb-6">Finalize technical scope for Final Investment Decision (FID).</p>

                                <h4 className="font-bold text-gray-900 mb-2 text-sm uppercase">Deliverables</h4>
                                <ul className="text-sm text-gray-600 space-y-2 list-disc pl-4">
                                    <li>Finalized P&IDs</li>
                                    <li>Detailed Equipment Datasheets</li>
                                    <li>HAZOP Study</li>
                                    <li>3D Model (PDS/PDMS/E3D)</li>
                                    <li>Cost Estimate (Class 3 / ±10-15%)</li>
                                </ul>
                            </div>
                        </div>
                    </div>
